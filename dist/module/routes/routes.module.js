...
RoutesModule = __decorate([
    (0, common_1.Module)({
        imports: [shared_module_1.SharedModule, auth_module_1.AuthModule, users_module_1.UsersModule],
        controllers: [routes_controller_1.RoutesController],
        providers: [routes_service_1.RoutesService, routes_repositoryImpl_1.RoutesRepositoryImpl],
